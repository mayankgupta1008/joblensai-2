...
const features = [
  {
    ...
    title: "Swipe on Jobs",
    description:
      "Browse curated job listings tailored to your skills. Swipe right on roles you love, left on ones you don't.",
  },
  {
    icon: Bot,
    title: "AI Agent Outreach",
    description:
      "Our LangGraph-powered agent crafts personalized emails and applies on your behalf automatically.",
  },
  {
    icon: FileText,
    title: "Smart Resume Match",
    description:
      "Your resume is analyzed and matched with job requirements for higher success rates.",
  },
  {
    icon: Mail,
    title: "Automated Emails",
    description:
      "Personalized cover letters and emails sent directly to hiring managers. No templates.",
  },
];
...
const howItWorks = [
  {
    ...
    description:
      "Add your resume and let our AI understand your skills, experience, and career goals.",
  },
  {
    step: "02",
    title: "Swipe on Jobs",
    description:
      "Browse job cards Tinder-style. Swipe right on jobs you want, left on ones you don't.",
  },
  {
    step: "03",
    title: "AI Takes Over",
    description:
      "Our agent researches the company, writes a personalized email, and applies for you.",
  },
  {
    step: "04",
    title: "Track & Succeed",
    description:
      "Monitor application status, responses, and interview invites all in one place.",
  },
];
...
export default function Landing() {
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto flex h-14 sm:h-16 items-center justify-between px-3 sm:px-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg sm:text-xl font-bold">
              Swipe<span className="text-gradient">Jobs</span>
            </span>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <Button
              size="sm"
              className="gradient-primary border-0 shadow-glow text-xs sm:text-sm px-3 sm:px-4"
              asChild
            >
      ...
      <section className="relative pt-20 sm:pt-24 md:pt-32 pb-12 sm:pb-16 md:pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p
              className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-8 md:mb-10 max-w-2xl mx-auto animate-fade-in px-2"
              style={{ animationDelay: "0.1s" }}
            >
              The Tinder for job hunting. Swipe on jobs you love, and let our AI
              agent craft personalized applications and send them for you.
            </p>
            <div
            ...
            >
              <Button
                size="lg"
                className="gradient-primary border-0 text-base sm:text-lg px-6 sm:px-8 h-12 sm:h-14 shadow-glow w-full sm:w-auto"
                asChild
              >
                <Link to="/swipe">
                  Start Swiping Free
            ...
            {/* Stats */}
            <div
              className="mt-10 sm:mt-12 md:mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 animate-fade-in-up"
          ...
          {/* Swipe Preview */}
          <div
            className="mt-12 sm:mt-16 md:mt-20 relative animate-fade-in-up hidden sm:block"
              ...
              <div className="relative rounded-2xl border border-border bg-card overflow-hidden shadow-2xl">
                <div className="aspect-[3/4] bg-gradient-to-br from-secondary to-muted p-4 sm:p-6 flex flex-col">
                  ...
                  <p className="text-muted-foreground text-xs sm:text-sm flex-1">
                    Join our team to build the next generation of web
                    experiences. We're looking for passionate engineers who love
                    creating beautiful, performant user interfaces at scale...
                  </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-10 sm:mb-12 md:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-3 sm:mb-4">
              Job Hunting,<span className="text-gradient"> Reinvented</span>
            </h2>
            <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto px-2">
              Stop spending hours on applications. Let AI do the heavy lifting
      ...
      <section
        id="how-it-works"
        className="py-12 sm:py-16 md:py-24 border-t border-border bg-secondary/20"
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-10 sm:mb-12 md:mb-16">
            <Badge className="mb-3 sm:mb-4" variant="outline">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-3 sm:mb-4">
              Four Steps to{" "}
              <span className="text-gradient-accent">Your Next Role</span>
            </h2>
            <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto px-2">
          ...
          <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden">
            ...
            <div className="relative text-center py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8">
              ...
              <p className="text-base sm:text-lg text-muted-foreground mb-6 sm:mb-8 max-w-xl mx-auto">
                Join thousands of job seekers who've transformed their search
                with AI-powered applications.
              </p>
              <Button
                size="lg"
                className="gradient-primary border-0 shadow-glow h-12 sm:h-14 px-6 sm:px-8 text-base sm:text-lg w-full sm:w-auto"
                asChild
              >
                <Link to="/swipe">
                  Start Swiping Now
