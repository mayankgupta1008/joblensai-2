  ...
  return (
    <div className="relative min-h-screen selection:bg-emerald-500/30 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 py-10 md:py-16 max-w-7xl">
        <section className="relative overflow-hidden rounded-4xl border border-brand-border bg-background/40 backdrop-blur-xl p-8 md:p-12 mb-10 shadow-2xl dark:bg-white/5 dark:ring-1 dark:ring-white/10">
...
const AssetCard = ({ title, description, icon: Icon, badge, onView, onDelete, tone }: any) => (
  <Card
    className={cn(
      "relative overflow-hidden rounded-4xl border-brand-border bg-background/40 backdrop-blur-xl shadow-xl group/card dark:bg-white/5 dark:ring-1 dark:ring-white/10",
