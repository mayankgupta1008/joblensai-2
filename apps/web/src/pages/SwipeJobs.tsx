...
const mockJobs: Job[] = [
  {
    ...
    description:
      "Join our team to build the next generation of web experiences. We're looking for passionate engineers who love creating beautiful, performant user interfaces at scale.",
  },
  {
    id: "2",
    ...
    description:
      "Help us build the economic infrastructure for the internet. Work on challenging problems at scale and ship code that powers millions of businesses.",
  },
  {
    id: "3",
    ...
    description:
      "Design the future of collaborative design tools. Work closely with engineers and PMs to ship features used by millions of designers worldwide.",
  },
  {
    id: "4",
    ...
    description:
      "Build the infrastructure that powers AI models serving billions of requests. Work on cutting-edge technology that's shaping the future of AI.",
  },
  {
    id: "5",
    ...
    description:
      "Create the best music streaming experience on mobile. Work on features used by hundreds of millions of users every day.",
  },
];
          ...
          <div className="mb-6 space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium">
                {currentIndex}/{jobs.length} viewed
              </span>
            </div>
            <Progress
              value={(currentIndex / jobs.length) * 100}
              className="h-2"
            />
          </div>
                ...
                <Card
                  ...
                  style={{
                    transform: isDragging
                      ? `translateX(${dragOffset}px) rotate(${getRotation()}deg)`
                      : undefined,
                  }}
                    ...
                    <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
                      ...
                      <Badge
                        ...
                        className={cn(
                          ...
                          currentJob.match >= 90
                            ? "gradient-like text-success-foreground border-0"
                            : "",
                        )}
                      >
                        {currentJob.match}%
