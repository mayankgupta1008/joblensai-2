...
const NavBar = () => {
  ...
  const mobileAuthMenu = () => (
    <div className="space-y-6">
      ...
      <div className="space-y-1">
        {mobileLink({ to: "/dashboard", icon: LayoutDashboard, children: "Dashboard" })}
        {mobileLink({ to: "/notifications", icon: Bell, children: "Notifications" })}
        {mobileLink({ to: "/upload", icon: Flame, children: "Swipe jobs" })}
        {mobileLink({ to: "/dashboard", icon: UserIcon, children: "Profile" })}
        {mobileLink({ to: "/subscription", icon: CreditCard, children: "Subscription" })}
        {mobileLink({ to: "/dashboard", icon: Settings, children: "Settings" })}
      </div>
  ...
  const mobilePublicMenu = () => (
    <div className="space-y-6">
      <div className="space-y-1">
        {mobileAnchor({ href: "#features", icon: Sparkles, children: "Features" })}
        {mobileAnchor({ href: "#how-it-works", icon: ChevronRight, children: "How it works" })}
        {mobileAnchor({ href: "#pricing", icon: CreditCard, children: "Pricing" })}
        {mobileLink({ to: "/login", icon: BriefcaseBusiness, children: "Post a Job" })}
      </div>
